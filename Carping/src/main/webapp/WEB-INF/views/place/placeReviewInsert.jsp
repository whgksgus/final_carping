...
<body>
	...
	<form action="placeReviewInsert.do" method="post" enctype="multipart/form-data">
		...
		<article>
			...
			<div class="container" style="font-family: 'Sunflower', sans-serif;">
				<div class="col-md-2"></div>
				<div class="col-md-8 vcenter">
				<label class="col-md-2 text-center vcenter" style="font-size: 1.5em;">제목</label><input type="text" name="prTitle"class="col-md-8 form-control align-self-center" style="width : 50%;" required>
  ...
  <output for="star-input"><input id="result" type="text" value="0" style="border: none; margin-top: -500px; font-size: 1.4em;" size="1"></output>
			...
			<div class="container" style="font-family: 'Sunflower', sans-serif;">
				<div class="col-md-2"></div>
				<div class="col-md-8">
					<label class="col-md-2 text-center vcenter" style="font-size: 1.5em;">내용</label><textarea name="prContent" class="col-md-6 form-control" cols="5" rows="10" style="margin: 0px; width: 564px; height: 325px; resize: none;" required></textarea>
				</div>
				<div class="col-md-2"></div>
			</div>
			<br>
